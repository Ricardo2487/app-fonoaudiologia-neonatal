...
async def seed_database():
    ...
    exercises = [
        ...
        {
            "id": str(uuid.uuid4()),
            "title": "Exercício do Som /S/ com Vídeo Guia",
            "description": "Melhore a articulação do som /S/ sibilante com demonstração em vídeo",
            "category": "fonema",
            "difficulty_level": "fácil",
            "media_urls": ["https://www.youtube.com/embed/tcOuAdJMxO0"],
            "instructions": "1. ASSISTA O VÍDEO demonstrativo\n2. Coloque a língua atrás dos dentes superiores\n3. Deixe o ar passar pelos lados\n4. Repita: sapo, casa, osso, passo\n5. Pratique em frente ao espelho\n6. Segure o som /S/ por 10 segundos",
            "estimated_time": 10,
            "frequency": "diário",
            "created_by": "admin",
            "created_at": datetime.now(timezone.utc).isoformat()
        ...
        {
            "id": str(uuid.uuid4()),
            "title": "Respiração Diafragmática - Vídeo Tutorial",
            "description": "Fortalecimento da respiração para melhor controle vocal com vídeo passo a passo",
            "category": "respiração",
            "difficulty_level": "fácil",
            "media_urls": ["https://www.youtube.com/embed/ik5E2_Rrltc"],
            "instructions": "1. ASSISTA O VÍDEO completo primeiro\n2. Deite-se confortavelmente\n3. Coloque uma mão no peito e outra na barriga\n4. Inspire pelo nariz enchendo a barriga\n5. Expire lentamente pela boca\n6. Repita 10 vezes\n7. Pratique expansão das costelas laterais",
            "estimated_time": 10,
        ...
        {
            "id": str(uuid.uuid4()),
            "title": "Vocalização de Vogais - Tutorial em Vídeo",
            "description": "Exercício para clareza e projeção vocal com demonstração profissional",
            "category": "voz",
            "difficulty_level": "fácil",
            "media_urls": ["https://www.youtube.com/embed/fX9SJmXn4c8"],
            "instructions": "1. ASSISTA O VÍDEO de aquecimento vocal\n2. Fique em pé, com postura ereta\n3. Inspire profundamente pelo nariz\n4. Vocalize cada vogal sustentando por 5 segundos: A-E-I-O-U\n5. Varie a intensidade e o tom gradualmente\n6. Repita 3 séries\n7. Descanse 30 segundos entre séries",
            "estimated_time": 12,
            "frequency": "diário",
            "created_by": "admin",
            "created_at": datetime.now(timezone.utc).isoformat()
